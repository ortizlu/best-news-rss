...
/** Cleaned RSS 2.0 for any source URL: /rss?url=https://example.com/feed.xml */
export async function GET(request: NextRequest) {
  ...
  if (!url) {
    return rssError(
      "Missing url query parameter. Example: /rss?url=https://feeds.bbci.co.uk/news/world/rss.xml",
      400,
    );
  }
