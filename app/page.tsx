...
export default function Home() {
  ...
  return (
    <main className="container">
      <h1>Best News RSS</h1>
      <p className="lead">
        Add RSS sources you trust. This app strips HTML bloat, tracking
        parameters, and full-article markup so Dakboard gets a title, source
        name, timestamp, and short summary per story.
      </p>
      ...
      <section className="card" style={{ borderColor: "var(--accent)" }}>
        ...
        <p className="hint">
          With clickable links and lead images:
        </p>
        <code
          style={{
            display: "block",
        ...
        >
          {origin
            ? dakboardFullUrl()
            : "https://best-news-rss.vercel.app/rss/all/full"}
        </code>
        <div className="feed-actions">
          <a
            href={origin ? dakboardAllUrl() : "#"}
            target="_blank"
            rel="noreferrer"
          >
            Open text-only RSS
        ...
        <div className="options-grid">
          <label>
            <input
              ...
              onChange={(e) =>
                setPrefs((p) => ({ ...p, stripHtml: e.target.checked }))
              }
            />
        ...
        <div className="form-row" style={{ marginTop: "1rem" }}>
          ...
          <input
            ...
            onChange={(e) =>
              setPrefs((p) => ({
                ...p,
                maxDescriptionLength: Number(e.target.value) || 400,
              }))
            }
          />
        </div>
        <p className="hint">
          Each saved feed gets a public <strong>RSS 2.0 URL</strong> — paste it
          into Dakboard’s RSS widget, or any reader.
        </p>
      </section>
      ...
      <section className="card">
        ...
        {loading ? (
          ...
          <p className="empty">
            No feeds yet. Add one above, or edit{" "}
            <code>data/feeds.json</code> in the repo and redeploy.
          </p>
        ) : (
              ...
              <li key={feed.id}>
                ...
                <div className="feed-actions">
                  ...
                  <button
                    ...
                    className="btn-ghost"
                    onClick={() =>
                      navigator.clipboard.writeText(dakboardUrl(feed))
                    }
                  >
                    Copy Dakboard URL
                  </button>
      ...
      <section className="card">
        ...
        <p className="hint" style={{ marginTop: 0 }}>
          Returns RSS XML directly — no account or JSON. Use in Dakboard without
          saving the feed:
        </p>
        <code
          style={{
